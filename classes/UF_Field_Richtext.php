...
class UF_Field_Richtext extends UF_Field_Textarea {
	...
	function display_input() {
		...
		if( version_compare( $wp_version, '4.3', '>=' ) ) {
			    ...
			    <div id="wp-' . $this->mce_id . '-editor-tools" class="wp-editor-tools hide-if-no-js">
			        <div id="wp-' . $this->mce_id . '-media-buttons" class="wp-media-buttons">' . $media_buttons . '</div>
			            <div class="wp-editor-tabs">
			                <button type="button" id="' . $this->mce_id . '-tmce" class="wp-switch-editor switch-tmce" data-wp-editor-id="' . $this->mce_id . '">' . __( 'Visual' )  . '</button>
			                <button type="button" id="' . $this->mce_id . '-html" class="wp-switch-editor switch-html" data-wp-editor-id="' . $this->mce_id . '">' . __( 'Text' ) . '</button>
			            </div>
			        </div>

			        <div id="wp-' . $this->mce_id . '-editor-container" class="wp-editor-container">
			            <div id="qt_' . $this->mce_id . '_toolbar" class="quicktags-toolbar"></div>
		...
		} elseif( version_compare( $wp_version, '3.8.2', '>' ) ) {
			echo '<div id="wp-' . $this->mce_id . '-wrap" class="wp-core-ui wp-editor-wrap tmce-active" data-mce-id="' . $this->mce_id . '">
				<div id="wp-' . $this->mce_id . '-editor-tools" class="wp-editor-tools hide-if-no-js">
					<div id="wp-' . $this->mce_id . '-media-buttons" class="wp-media-buttons">' . $media_buttons . '</div>

					<div class="wp-editor-tabs">
						<a id="' . $this->mce_id . '-html" class="wp-switch-editor switch-html" onclick="switchEditors.switchto(this);">' . __( 'Text' ) . '</a>
						<a id="' . $this->mce_id . '-tmce" class="wp-switch-editor switch-tmce" onclick="switchEditors.switchto(this);">' . __( 'Visual' )  . '</a>
					</div>
				</div>
			...
			echo '<div id="wp-' . $this->mce_id . '-wrap" class="wp-editor-wrap tmce-active" data-mce-id="' . $this->mce_id . '">
					<div id="wp-' . $this->mce_id . '-editor-tools" class="wp-editor-tools">
						...
						<a id="' . $this->mce_id . '-tmce" class="hide-if-no-js wp-switch-editor switch-tmce" onclick="switchEditors.switchto(this);">' . __( 'Visual' )  . '</a>
