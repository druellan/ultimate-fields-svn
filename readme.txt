A fork of Ultimate Fields WP Plugin, based on the latests SVN version 1.0.4.

=== Ultimate Fields ===
Contributors: RadoGeorgiev
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=QNZXU5VDH6PNQ
Tags: custom fields, meta, theme options, repeater, framework
...
* **Multilingual Fields** are supported by automatic integration with [qTranslate](http://wordpress.org/plugins/qtranslate/).
